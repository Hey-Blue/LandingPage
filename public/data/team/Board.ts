...
export const staticTeamMembers: TeamMember[] = [
  {
      ...
      role: 'President',
      bio: `We're thrilled to shine a spotlight on the incredible work of Jeremy Bohannon, a former football player turned Austin Police Department officer. 🙌
  
  🏟️ On the Gridiron: Jeremy played his heart out for Washington State University from 2001 to 2004, making tackles and interceptions as a defensive back.
  ...
  🌉 Building Bridges: Jeremy is known for tirelessly working to bridge the gap between the community and law enforcement. He's championed police reforms and reached out to youth through reading and sports programs.
  
  🤝 Connecting Amid Unrest: In 2020, amid social justice unrest, Jeremy stood out as the officer who worked the George Floyd Protests and then returned in plain clothes to engage in conversations, fostering understanding between officers and protesters.
  
  🏆 Award-Winning Commitment: His dedication to community policing earned him the Community Policing Award from the Cal Ripken Sr. Foundation.
  ...
  Jeremy Bohannon embodies the spirit of bridging divides and creating lasting connections. Let's celebrate his inspiring commitment to making our communities safer and more united! 🌟`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZhydHiA7mI742lZPixKk5XSR1rcw9Yzuv6Fyp'
  },
  {
      id: '62',
      name: 'Kyle Dobson',
  ...
  🔬 A Research Process That Makes a Difference:
  ...
  🌟 Join us in welcoming Kyle Horstead Dobson to the Hey, Blue! family! His expertise in building authentic connections and fostering inclusive environments will be instrumental in our mission to strengthen the bonds between law enforcement and the communities they serve.`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZi1XCBLQd4je25EJPgKfnwhZYvTxQUraDGLOR'
  },
  {
      id: '63',
      name: 'Elizabeth Ward-Cuprill',
      role: 'Secretary',
      bio: `Celebrating Elizabeth Ward-Cuprill - A Passionate Advocate for Community and Change! 🌟
  ...
  💙 Hey, Blue! and Elizabeth's Common Vision:
  ...
  🌟 Join us in celebrating Elizabeth Ward-Cuprill's dedication to community-driven change and her invaluable contribution to our mission. Together, we can build a world where positive connections and shared experiences inspire lasting transformation! 🌟💪💙`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZ6F6pV3PHWVazUP2geYB8Mvy7nJ4QZ3dKFSmk'
  },
  {
      id: '64',
      name: 'Ayana Verdi',
  ...
  We're proud to have Ayana Verdi on Hey, Blue!'s Board of Directors, where her journey serves as a testament to her dedication to creating a brighter future for all.`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZ3mV4Lzxc6Z2MU8rfbQODKsTCdkezG7vHYLXg'
  },
  {
      id: '65',
  ...
  🤝 Big Brothers Big Sisters: What They're About:
  ...
  🤝 Hey, Blue! & Big Brothers Big Sisters:
  ...
  Join us in celebrating Bryan Zebleckes' dedication to mentorship and his commitment to creating brighter futures for children and communities. Together, we can build a world where positive connections and mentorship create lasting change!`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZmvTis108JGcF6d9CDOMpjsXkuZW1x2UbVyYP'
  },
  {
      id: '71',
      name: 'Sergeant C.B. Fleming',
      role: 'Member At Large',
      bio: `Sgt. C.B. Fleming may not wear a cape, but he's a true hero to his community, and we're proud to announce that he's now part of the Hey, Blue! board. 🤝
  ...
  Corporal Fleming's dedication to fostering a safe, nurturing environment for these kids isn't just a job—it's a calling. It's a reminder that every child deserves to feel safe and supported, and it's a testament to the power of community policing. 🚀
  
  His actions were captured in a heartwarming video that went viral. But it's not just about one moment; it's about 15 years of commitment to South Hill's community. As a father of six, including two adopted children, Sgt. Fleming has always strived to be a positive force. 👨‍👧‍👦
  
  He once said, "If I could be that bright spot in someone's day, then that's all that mattered." Well, Sgt. Fleming, you've not only been that bright spot but also a superhero to countless kids in your community. 🌟
  
  Your dedication to building connections aligns perfectly with Hey, Blue!'s mission. We're thrilled to have you on board! 🎉`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZLXQ8KsZ91EfDaAt2gSTH7JwOeo3kGbWIzCsL'
  },
  {
      id: '67',
      name: 'Marcus Claycomb',
      role: 'Member At Large',
      bio: `From Commander with the Melbourne Police Department to Business Development Manager at Panasonic North America, Marc Claycomb's journey is nothing short of inspiring. And now, we're proud to announce that he's a valuable member of the Hey, Blue! Board. 🤝
  
  Marc's career spans 30 years in law enforcement, during which he strengthened the bond between the community and the Melbourne Police Department. His dedication was so profound that members of the community cried when he retired, asking if there was a way to make him stay. 🙏
  ...
  As a Business Development Manager for Public Sector at Panasonic Connect North America, Marc collaborates with internal and external partners to innovate technologies and develop solutions in law enforcement, fire/rescue, and medical fields. 🚓🚒🏥
  
  🌟Marc's credentials include being a proud graduate of the FBI National Academy Associates, Inc. (FBINAA) National Academy Session #273. This achievement signifies his dedication to the foundational pillars of the FBI National Academy: leadership, integrity, courage, and personal growth. These pillars are not just principles; they are the cornerstones of community policing. Marc's commitment to these values has not only shaped his career but also enhanced his ability to foster positive connections between law enforcement and the community and that aligns perfectly with Hey, Blue!'s mission. 🌟
  ...
  Join us in celebrating Marc Claycomb's remarkable journey, his unwavering support of the community, and his dedication to the principles that drive community policing forward.`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZPBvQYaGaitFzx4vETRbSgjL8WQhwDfUVu2cq'
  },
  {
      id: '68',
  ...
  🌟 Alton's Impact: He's not just a legal eagle; he's also a community superhero! Alton dedicates a substantial 10-15 hours per week to giving back to his community, particularly as a mentor to children in Schools Public-Brevard County. His commitment doesn't stop there:
  
  👉 Chairman of the Cocoa Police Department Citizen Advisory Committee
  👉 Vice Chair of the Space Coast Recovery Center
  👉 Chairman of the Board for EMMA JEWEL CHARTER SCHOOL INC
  👉 Assistant Wrestling Coach at Cocoa High School
  👉 Sponsor of various high school sports teams and community initiatives
  
  💪 Advocate for Justice: In 2020, Alton co-organized one of the largest peaceful marches in Brevard County, "The March for Justice," in response to the tragic loss of George Floyd. His passion for justice and equality shines through in all his endeavors.
  
  🚓 Collaborating for Change: Alton's collaboration with the Cocoa Police Department, through his partnership with Hey, Blue!, has led to the creation of a series of educational videos on "What to Do When Pulled Over by the Police." He firmly believes that we all play a role in keeping each other safe, and prioritizing life preservation in police interactions.
  
  📚 Author & Mentor: Alton is also the author of the heartwarming children's book, "Don't Be Sad: Based on a True Story of Conquering Sadness." His book carries a powerful message of hope and resilience, reflecting his dedication to empowering young minds.
  
  🤝 Alton Edmond is the living embodiment of Hey, Blue!'s mission: where #community meets #connection, real #change happens.
  ...
  Join us in celebrating his dedication and contributions to fostering positive relationships between law enforcement and the communities they serve. Together, we can make a difference!`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZsQxxwIvSidoI8Dh7Uj3kYPaJcryqVpfZ9mCu'
  },
  {
      id: '69',
  ...
  💪 In addition, her role as a certified RPLB: Resilience-Building Leader Program professional trainer signifies her commitment to building positive connections between law enforcement and communities, enhancing resilience, and promoting cooperation. Her participation in LEAD Brevard's 2023 cohort, where she engaged in Hey, Blue!'s community acceleration project, has provided firsthand experience of the effectiveness of our initiatives, inspiring her to volunteer for our board.
  
  🪧 As a ForbesBLK Member, Dr. Weatherspoon's influential leadership plays a pivotal role in advancing Hey, Blue!'s mission.
  
  💼 Her strategies for improving employee engagement align perfectly with our vision for better community interactions.
  
  🤝 As the 2nd Vice President of the Omega Omicron Zeta Chapter of Zeta Phi Beta Sorority, Inc. - Official, she is responsible for ensuring that the chapter members are well informed, aware, and engaged in social justice issues and social action programming across the county.
  ...
  Dr. Gloria Linette Weatherspoon's accomplishments and fervor for diversity and equity reflect the very essence of Hey, Blue!. We're honored to have her as a part of our team, and together, we will continue to make a positive impact on our community! 🌆🤗`,
      imageLink: 'https://utfs.io/f/xPb29TA7HRGZ3LqTGHxc6Z2MU8rfbQODKsTCdkezG7vHYLXg'
  },
  {
    id: '70',
    ...
    bio: `Jeremy Lahar wears many hats, and he wears them with pride. As a CEO, speaker, mentor, sergeant, and now an author (https://lnkd.in/ekEmfpJ6).
        ...
        💬 Believer in Communication: Jeremy firmly believes that policing is 90% about communication and building relationships within the community and only 10% law enforcement.

        🎤 A Gifted Speaker: The Houston Police Department recognized Jeremy's gift for communication and selected him as a public speaker for over 100 different engagements. Topics ranged from personal safety to police and citizen interaction, highlighting his commitment to community well-being.

        🌟 Visionary Initiatives: He's been the visionary behind several HPD Public Affairs projects and events, including The Badges and Bears Project, The Senior Citizen Interaction Program, The Triple C Podcast (Cops Communicating with the Community), and the "Feet On The Street" video series, humanizing law enforcement.

        🤝 Mentorship Matters: Jeremy founded The Houston Prestige Project, a non-profit 501(c)(3) organization, focused on mentorship and empowering teen boys ages 10-18 into future leaders. His work has positively impacted hundreds of young lives in Houston.

        🌟 Jeremy Lahar's commitment to building connections, fostering communication, and empowering communities aligns perfectly with Hey, Blue!'s mission. We're honored to have him on our board! 🌟`,
    imageLink: 'https://utfs.io/f/xPb29TA7HRGZ5XtEZHzAt6lwDp41dFr7vEfXShHzabKmoikM'
  },
];