...
const AppShowcase = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#4facfe] to-[#00f2fe]">
      <Header />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <motion.div
              ...
              className="space-y-6"
            >
              <h1 className="text-5xl md:text-6xl font-bold text-white text-center text-center">
                Hey Blue!
              </h1>
              <p className="text-xl text-white/90 text-center text-center">
