...
const ContactUsPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const formUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSdwLeYgViwvhYaHnmVQi4UVqgF9r_RGaVOxCHjeR2R44RDrvw/formResponse';
    const formDataToSubmit = new FormData();
    formDataToSubmit.append('entry.590691505', formData.email);
    formDataToSubmit.append('entry.1391184925', formData.name);
    formDataToSubmit.append('entry.534385872', formData.message);
